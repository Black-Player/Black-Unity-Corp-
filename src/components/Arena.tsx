...
export default function Arena({ userProfile, addToast }: { userProfile: UserProfile, addToast: any }) {
  ...
  const eliteOracles: EliteOracle[] = [
    { id: '1', name: 'Zion Master', win_rate: 82, total_pnl: 45000, followers: 1240, risk_score: 3, strategy: 'SMC + ICT Confluence', avatar: 'https://picsum.photos/seed/zion/100/100', verified: true },
    { id: '2', name: 'Cosmic Weaver', win_rate: 75, total_pnl: 28000, followers: 850, risk_score: 2, strategy: 'Trend Following EMA', avatar: 'https://picsum.photos/seed/weaver/100/100', verified: true },
    { id: '3', name: 'Zulu Prophet', win_rate: 68, total_pnl: 15000, followers: 420, risk_score: 4, strategy: 'Scalping Volatility', avatar: 'https://picsum.photos/seed/zulu/100/100', verified: false },
    { id: '4', name: 'Solar Oracle', win_rate: 91, total_pnl: 120000, followers: 3500, risk_score: 1, strategy: 'Institutional Order Flow', avatar: 'https://picsum.photos/seed/solar/100/100', verified: true },
  ];
            ...
            {filteredOracles.map((oracle) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                  ...
                  <button 
                    onClick={() => addToast(`Mirroring ${oracle.name}'s strategy...`, 'success')}
                    className="px-4 py-2 rounded-xl bg-gold/10 border border-gold/20 text-gold text-[10px] font-bold uppercase tracking-widest hover:bg-gold hover:text-black transition-all"
                  >
                    Mirror Strategy
                  </button>
                </div>
